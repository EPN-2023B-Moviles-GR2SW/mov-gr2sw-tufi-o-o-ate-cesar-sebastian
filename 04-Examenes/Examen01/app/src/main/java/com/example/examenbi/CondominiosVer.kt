...
class CondominiosVer : AppCompatActivity() {
    val arregloCondominios = CondominioDAO().getAll()
    ...
    override fun onCreateContextMenu(
        ...
        val condominioSeleccionado = arregloCondominios.get(posicion)
    ...
    fun abrirDialogo() {
        ...
        builder.setPositiveButton(
            ...
            CondominioDAO().deleteById(idCondominioSeleccionado)
